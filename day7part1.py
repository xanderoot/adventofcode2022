...
currentLocation = ['/'] # append and pop as needed to log location, gets passed to def

splitCommands = []

for x in range(len(commands)):
    currentCommand = commands[x].split(' ')
    if currentCommand[0] == '$': currentCommand.pop(0)
    splitCommands.append(currentCommand.copy())

for inner_list in splitCommands: # generated using chat.openai.com
